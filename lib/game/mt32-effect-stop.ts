 ...
 * MT15 owner stop and retained timer reinitialization.
 */
export function stopOriginalMt32Effect(before:OriginalMt32EffectState&{markers:Uint8Array},handle:number,master:number){
 ...
 const stopped=stopOriginalMt32Track(timers,voices,handle);writes.push(...stopped.writes);
