import {createOriginalMusicRuntime,type OriginalMusicSeed} from './music-runtime.ts';
import {originalMenuAudioControl,type OriginalMenuAudioState} from './menu-audio-control.ts';
/** Original menu control operations applied to the running AdLib score. */
export function createControlledOriginalMusic(seed:OriginalMusicSeed){
 const runtime=createOriginalMusicRuntime(seed);
