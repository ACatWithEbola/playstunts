 ...
 <div className="faq-layout">
  ...
  <div className="faq-content">
   ...
   <Section id="graphics-sound" kicker="02" title="Graphics &amp; sound">
    ...
    <Answer question="Can I use the original graphics?"><p>Yes. Enhanced graphics is enabled when the game launches. Choose <strong>Use original graphics</strong> above the game to switch to the display mode selected in Setup. Only that website control changes the renderer; opening an in-game menu does not change your graphics choice.</p></Answer>
    <Answer question="What does the audio update change?"><p>The four remixed music cues are enabled when the game launches. Choose <strong>Use original music</strong> to switch back. Sound effects and engine audio remain unchanged. Both versions follow the same playback clock, so changing modes continues at the corresponding position instead of restarting the music. The in-game Options menu still controls whether music is on or off; turning it back on restarts the current score in either version.</p></Answer>
