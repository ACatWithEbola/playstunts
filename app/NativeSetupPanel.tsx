...
export default function NativeSetupPanel({onClosed}:{onClosed?:()=>void|Promise<void>}){
 ...
 return <section className="native-setup-panel" data-running={running?"true":"false"} aria-label="Stunts Setup">
  ...
  <div className="launcher-screen">
   ...
   {!running&&<Image className="setup-menu-preview" src="/site/setup-menu.png" alt="Stunts Setup menu: display, sound and exit" fill unoptimized style={{objectFit:"fill",objectPosition:"center"}}/>}
  </div>
