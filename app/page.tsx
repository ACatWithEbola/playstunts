...
export default function Home(){
 ...
 return <main className="game-shell stunts-launcher stunts-universe" id="top">
  ...
  <nav className="stunts-navigation" aria-label="Main navigation"><a className="nav-play" href="#play">PLAY</a><a href="#setup">SETUP</a><a href="#about">THE GAME</a><a href="#roland">MT-32</a><a href="https://pigsgrame.de/downloads/stunts.pdf" target="_blank" rel="noreferrer">MANUAL ↗</a><span>BUILT FOR THE BROWSER</span></nav>
  <div className="launcher-grid">
   <aside className="stunts-manual-rail" aria-label="Original Stunts manual">
    <a className="manual-cover" href="https://pigsgrame.de/downloads/stunts.pdf" target="_blank" rel="noreferrer" aria-label="Read the original Stunts manual (PDF)"><Image unoptimized width={800} height={967} src="/site/manual-front-cover.jpg" alt="Original Stunts manual cover"/></a>
    <p className="rail-kicker">FROM THE ORIGINAL MANUAL</p><p className="rail-statement">ELEVEN CARS.<br/>SIX OPPONENTS.<br/>YOUR OWN TRACKS.</p>
   ...
   <div className="stunts-setup-column"><section className="launcher-station stunts-setup-station" id="setup" aria-labelledby="setup-heading"><h2 id="setup-heading">GAME SETUP</h2><NativeSetupPanel onClosed={setupClosed}/><div className="launcher-settings-state"><p role="status">{settingsNotice||'Saving changed settings restarts the game automatically.'}</p></div></section><section className="launcher-station stunts-shortcuts" aria-labelledby="shortcuts-heading"><h2 id="shortcuts-heading">KEYBOARD SHORTCUTS</h2><h3>Driving</h3><dl><dt><kbd>↑</kbd> / <kbd>↓</kbd></dt><dd>Accelerate / brake</dd><dt><kbd>←</kbd> / <kbd>→</kbd></dt><dd>Steer left / right</dd><dt><kbd>Space</kbd> / <kbd>Enter</kbd></dt><dd>Shift up / down with manual gears</dd><dt><kbd>Esc</kbd></dt><dd>Open the game menu</dd></dl><h3>Views &amp; replay</h3><dl><dt><kbd>C</kbd></dt><dd>Cycle camera views</dd><dt><kbd>F1</kbd>–<kbd>F4</kbd></dt><dd>Select a camera directly</dd><dt><kbd>t</kbd></dt><dd>Switch to the opponent’s view when racing an opponent</dd><dt><kbd>Ctrl</kbd> + arrows</dt><dd>Adjust the replay camera</dd><dt><kbd>+</kbd> / <kbd>−</kbd></dt><dd>Zoom the replay camera</dd><dt>Arrow keys</dt><dd>Select a replay control</dd><dt><kbd>Enter</kbd> / <kbd>Space</kbd></dt><dd>Activate the selected replay control</dd></dl></section></div>
 ...
 <section className="launch-info" aria-label="About this browser edition"><p><strong>Public beta</strong> · Unofficial Stunts browser reconstruction. Not an official release from the original developers or Roland.</p><p>Best played on a computer with a keyboard. Some graphics and audio issues are still being investigated. <a href="mailto:svenanders@lokaas.net?subject=PlayStunts%20bug%20report">Report a bug</a> — please include your browser, sound/display settings, and steps to reproduce it.</p><SaveBackupPanel running={running}/></section>
 </main>;
}
