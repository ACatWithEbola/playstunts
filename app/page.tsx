...
export default function Home(){
 ...
 return <main className="game-shell stunts-launcher stunts-universe" id="top">
  ...
  <div className="launcher-grid">
   ...
   <div className="stunts-setup-column"><section className="launcher-station stunts-setup-station" id="setup" aria-labelledby="setup-heading"><h2 id="setup-heading">GAME SETUP</h2><NativeSetupPanel onClosed={setupClosed}/><div className="launcher-settings-state"><p role="status">{settingsNotice||'Saving changed settings restarts the game automatically.'}</p></div></section><section className="launcher-station stunts-shortcuts" aria-labelledby="shortcuts-heading"><h2 id="shortcuts-heading">KEYBOARD SHORTCUTS</h2><h3>Driving</h3><p className="stunts-shortcut-note">Shift keys apply to manual gears.</p><dl><dt><kbd>↑</kbd> / <kbd>↓</kbd></dt><dd>Accelerate / brake</dd><dt><kbd>←</kbd> / <kbd>→</kbd></dt><dd>Steer left / right</dd><dt><kbd>A</kbd> / <kbd>Z</kbd></dt><dd>Shift up / down</dd><dt><kbd>Space</kbd> / <kbd>Enter</kbd></dt><dd>Alternative shift keys</dd><dt><kbd>Esc</kbd></dt><dd>Open the game menu</dd></dl><h3>Views &amp; replay</h3><dl><dt><kbd>C</kbd></dt><dd>Cycle camera views</dd><dt><kbd>F1</kbd>–<kbd>F4</kbd></dt><dd>Select camera</dd><dt><kbd>t</kbd></dt><dd>View the opponent’s car</dd><dt><kbd>Ctrl</kbd> + arrows</dt><dd>Adjust replay camera</dd><dt><kbd>+</kbd> / <kbd>−</kbd></dt><dd>Zoom the replay camera</dd><dt>Arrow keys</dt><dd>Select a replay control</dd><dt><kbd>Enter</kbd> / <kbd>Space</kbd></dt><dd>Use selected replay control</dd></dl></section></div>
