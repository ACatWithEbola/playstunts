...
export default function Home(){
 ...
 return <main className="game-shell stunts-launcher stunts-universe" id="top">
  ...
  <nav className="stunts-navigation" aria-label="Main navigation"><a className="nav-play" href="#play">PLAY</a><a href="#setup">SETUP</a><a href="#about">THE GAME</a><a href="#roland">MT-32</a><a href="https://pigsgrame.de/downloads/stunts.pdf" target="_blank" rel="noreferrer">MANUAL ↗</a><a href="#saves" onClick={()=>{const section=document.getElementById('saves');if(section instanceof HTMLDetailsElement)section.open=true;}}>TRACKS &amp; REPLAYS</a><span>BUILT FOR THE BROWSER</span></nav>
